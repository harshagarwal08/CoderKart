    ...
    const initiatePayment = async () => {
        ...
        var config = {
            ...
            "data": {
                ...
                "token": responseData.txnToken, /* update token value */
                "tokenType": "TXN_TOKEN",
        ...
        return (
            <div className="text-gray-600 mt-10 mb-20">
                ...
                <div className="container flex flex-col md:px-32 px-4 py-4 items-center">
                    ...
                    <Link href={"/order"}>
                        <button onClick={initiatePayment} className="mx-auto mt-2 text-white bg-sky-700 border-0 py-2 px-8 md:w-1/3 w-1/2 focus:outline-none hover:bg-sky-800 rounded lg:text-lg text-sm font-bold">PAY ₹{subTotal}</button>
                    </Link>
                </div>
            </div>
        )
